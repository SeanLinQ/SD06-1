...
void GPIO_Init (void)
{
  ...
  /*****led init*******/
	...
	GPIO_Mode			(GPIO_PORT1, GPIO_PIN1, GPIO_MODE_OUTPUT);
	GPIO_Set			(GPIO_PORT1, GPIO_PIN1);
	GPIO_Mode			(GPIO_PORT1, GPIO_PIN2, GPIO_MODE_OUTPUT);
	GPIO_Set			(GPIO_PORT1, GPIO_PIN2);
	GPIO_Mode			(GPIO_PORT1, GPIO_PIN3, GPIO_MODE_OUTPUT);
	GPIO_Set			(GPIO_PORT1, GPIO_PIN3);
	GPIO_Mode			(GPIO_PORT0, GPIO_PIN8, GPIO_MODE_OUTPUT);
	GPIO_Set			(GPIO_PORT0, GPIO_PIN8);
	GPIO_Mode			(GPIO_PORT3, GPIO_PIN9, GPIO_MODE_OUTPUT); 
	GPIO_Set			(GPIO_PORT3, GPIO_PIN9);
  ...
  GPIO_Mode			(GPIO_PORT0, GPIO_PIN9, GPIO_MODE_OUTPUT);// power led
	...
	GPIO_Config		(GPIO_PORT2, GPIO_PIN0, GPIO_CFG_REPEATER_MODE);	
	//P2.0 as both edge
	GPIO_P2Trigger(GPIO_PIN0,	GPIO_IS_EDGE, GPIO_IBS_BOTH_EDGE_TRIGGER, GPIO_IEV_RISING_EDGE);
	GPIO_Interrupt(GPIO_PORT2, GPIO_PIN0,	GPIO_IE_EN);	

  /******** N/L ****/
  //P0.5 as Input 
  GPIO_Mode			(GPIO_PORT0, GPIO_PIN5, GPIO_MODE_INPUT);
	//GPIO_Config		(GPIO_PORT1, GPIO_PIN4, GPIO_CFG_REPEATER_MODE);	
  ...
  GPIO_Mode			(GPIO_PORT0, GPIO_PIN2, GPIO_MODE_OUTPUT);
	...
	GPIO_Config		(GPIO_PORT3, GPIO_PIN8, GPIO_CFG_PULL_UP);
	GPIO_P3Trigger(GPIO_PIN8,	GPIO_IS_EDGE, GPIO_IBS_BOTH_EDGE_TRIGGER, GPIO_IEV_FALLING_EDGE );
...
//	}
//	else 
//	if(GPIO_IntStatus(GPIO_PORT0,GPIO_PIN2)==1)
//	{
...
//		}
		//if(IRQ_Count == 1)
		{
			//backup_value = SN_GPIO1->DATA &(0x1<<0);
			//backup_value &= 0x01;
		}
	}
	else
